...
| 数据类型 | 脱敏效果 | 匹配方式 |
|---------|---------|--------|
| 手机号 | `18135940826` → `181****0826` | 格式检测 + KV 键名 |
| Token/UUID | `a97f57ef-9889-...` → `a97f****c4f1` | 44 个通用敏感键名 |
| 账号 | `wyfa199613` → `wyf****9613` | KV 键名 (`account`, `userId`) |
| 身份证 | `110101199001011234` → `110101********1234` | 18 位格式检测 |
| 邮箱 | `admin@gyyx.cn` → `adm****@gyyx.cn` | 邮箱格式检测 |
